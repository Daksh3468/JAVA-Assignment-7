...
Question : Personal Loan Eligibility Criteria for Salaried Applicant is as 
follows:
Eligible Age Group - 21 years to 60 years
Minimum Net Monthly Income - Rs. 15,000
Minimum Total Work Experience - 1 year
Citizenship – Indian
Create a class AccountHolder to store above given information entered by a 
user. Create 5
objects of AccountHolder class and store them in an ArrayList. Display 
names of account
...
class AccountHolder {
    ...
    boolean isEligible() {
        if (this.age >= 21 && this.age <= 60 && this.monthly_income >= 15000 &&
                this.work_experience >= 1 && this.citizenship.equals("Indian")) {
            return true;
        } else {
            return false;
        }
